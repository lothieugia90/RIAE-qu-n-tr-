...
// Recipient requests return — sets status to pending_return, no signing yet
router.post('/assignments/:id/request-return', ctrl.requestReturn);
// Warehouse/admin direct return via signature page
